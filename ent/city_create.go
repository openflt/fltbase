...
func (cc *CityCreate) SetStateID(id int) *CityCreate {
	cc.mutation.SetStateID(id)
	return cc
}

// SetNillableStateID sets the "state" edge to the State entity by ID if the given value is not nil.
func (cc *CityCreate) SetNillableStateID(id *int) *CityCreate {
	if id != nil {
		cc = cc.SetStateID(*id)
	}
	return cc
...
func (cc *CityCreate) SetState(s *State) *CityCreate {
	return cc.SetStateID(s.ID)
}

// AddAirportIDs adds the "airports" edge to the Airport entity by IDs.
func (cc *CityCreate) AddAirportIDs(ids ...int) *CityCreate {
	cc.mutation.AddAirportIDs(ids...)
	return cc
}

// AddAirports adds the "airports" edges to the Airport entity.
func (cc *CityCreate) AddAirports(a ...*Airport) *CityCreate {
	ids := make([]int, len(a))
	for i := range a {
		ids[i] = a[i].ID
	}
